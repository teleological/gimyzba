...
The output (STDERR) of the program is a serialized ("pickled") sequence of
...
("candidates.db") of all possible gismu candidates. This database will be
consulted on subsequent executions.
